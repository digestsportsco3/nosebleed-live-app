...
const anomalies = [
  ...
  },
  {
    ...
    why: () => `Speed is only useful once you reach base; this player reaches under 30% of the time and still runs.`,
  ...
  },
  {
    ...
    why: () => `Twenty-five homers before age 23 puts a player on a short list of names.`,
  ...
  },
  {
    ...
    why: () => `An .850 OPS at 36 or older is rare outside the all-time greats.`,
  ...
  },
  {
    ...
    why: () => `Sub-3.25 ERA over 100 innings at 37+ is the kind of season that ages into a trivia answer.`,
  ...
  },
  {
    ...
    why: () => `A strikeout machine with a losing record is the purest "wins are a team stat" post.`,
  ...
  },
  {
    ...
    why: () => `170 innings with 120 strikeouts is a 1980s workload profile in 2026.`,
  ...
  },
  {
    ...
    why: () => `Getting on base 38% of the time with almost no home-run threat is a lost art.`,
...
const heat = [
  ...
  { key: "hot_bat_30", title: "Month-long heater", group: "hitting", window: "last30d", weight: 6,
    ...
    describe: (p, w) => `${w.label}: ${f3(w.AVG)}/${f3(w.OBP)}/${f3(w.SLG)}, ${w.HR} HR, ${w.RBI} RBI in ${w.G} games (source ${w.source})`,
    why: () => `A month at this level usually lands in the leaderboard for the month.`,
