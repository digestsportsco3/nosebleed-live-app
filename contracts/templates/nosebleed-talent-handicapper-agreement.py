...
story.append(P(
    ...
    "Ad-Driven Revenue and counts toward Qualifying Revenue once, under Section 5.3(d). <b>Account Payout "
...
story.append(P(
    "<b>5.6 Issuance mechanics.</b> NSL's Limited Liability Company Agreement (as amended from time to time, "
    "the \"Operating Agreement\") provides for Class B non-voting Common Units and reserves Units for the "
    "Milestone Units under this Agreement. If the Operating Agreement has not been adopted on the Effective "
    "Date, NSL will adopt it within one hundred twenty (120) days after the Effective Date. NSL will issue the "
    "Initial Units within thirty (30) days after the later of the Effective Date and the adoption of the "
    "Operating Agreement. Milestone Units will be issued within sixty (60) days after the applicable Milestone "
    "is reached or, if later, within thirty (30) days after the Operating Agreement is adopted. Each issuance "
    "is conditioned on the Contractor's execution of the joinder attached to the Operating Agreement and such "
    "other customary documents as "
...
story.append(P(
    ...
    "under Section 4.2, with that subscription revenue counting as Qualifying Revenue under Section 5.3(d). Account Payout "
